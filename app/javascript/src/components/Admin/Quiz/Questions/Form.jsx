...
const QuestionForm = ({
  ...
  >
    {({
      ...
      const optionTexts = values.options.map(opt =>
        opt.text.toLowerCase().trim()
      );
      const uniqueTexts = new Set(optionTexts);
      const areOptionsUnique = uniqueTexts.size === optionTexts.length;

      if (values.uniqueOptions !== areOptionsUnique) {
        setFieldValue("uniqueOptions", areOptionsUnique);
      }
              ...
              >
                ...
                <Input
                  ...
                  error={
                    ...
                    (!values.uniqueOptions && touched.uniqueOptions)
                  }
                  ...
                  onChange={({ target: { value } }) => {
                    ...
                    setFieldTouched("uniqueOptions", true);
                  }}
                />
                <Button
